    ...
    <div class="card">
        ...
        <div class="card-body">
            <div class="customer-order-detail">
                ...
                <br>
                <div>
                    <a href="{{ route('customer.print-order', $order->id) }}" class="btn btn-fill-out btn-sm">{{ __('Print order') }}</a>
                    @if ($order->canBeCanceled())
                        <a href="{{ route('customer.orders.cancel', $order->id) }}" class="btn btn-dark btn-sm">{{ __('Cancel order') }}</a>
                    @endif
                </div>
            </div>
        </div>
